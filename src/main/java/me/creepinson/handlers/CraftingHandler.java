...
public class CraftingHandler {
	...
	public static void init(){
		...
		CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(new ItemStack(ItemHandler.Wire, 3, 0), "  ", "III", "  ", 'I', new ItemStack(ItemHandler.CopperIngot, 1), "ingotCopper"));
